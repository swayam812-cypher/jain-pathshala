    ...
    <div className="flex min-h-screen items-center justify-center bg-cream px-6">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="font-display text-2xl text-slate">Jain Pathshala</h1>
          <p className="mt-1 text-sm text-slate/50">Sign in to continue your learning journey</p>
        </div>
        ...
        <p className="mt-5 text-center text-sm text-slate/60">
          New here? <Link to="/signup" className="text-maroon hover:underline">Create an account</Link>
        </p>
      </div>
    </div>
  );
